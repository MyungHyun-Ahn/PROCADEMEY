...
void Initial(void)
{
	...
	g_stPlayer.iX = dfSCREEN_WIDTH / 2;
	g_stPlayer.iY = dfSCREEN_HEIGHT / 2;
}
...
bool KeyProcess(void)
{
	...
	g_stPlayer.iX = min(g_stPlayer.iX, dfSCREEN_WIDTH - 2);
	g_stPlayer.iY = max(g_stPlayer.iY, 0);
	g_stPlayer.iY = min(g_stPlayer.iY, dfSCREEN_HEIGHT - 2);
